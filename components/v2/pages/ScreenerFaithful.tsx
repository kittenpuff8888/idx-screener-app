  ...
  return (
    <V2Shell active="screener" title="Setups Screener" meta={meta}>
      <main style={{ flex: 1, minWidth: 0, padding: "20px 26px 60px" }}>
        ...
        {/* Past Setups link */}
        <a href="/v2/screener/history" style={{ display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap", background: "var(--panel)", border: "1px solid var(--border)", borderRadius: "var(--r)", boxShadow: "var(--sh)", padding: "14px 18px", marginBottom: 16, textDecoration: "none", color: "var(--text)" }}>
