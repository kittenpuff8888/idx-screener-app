...
// set. No per-study length override here (deliberately) -- that was tried
// once and reliably broke the embed: typing into a length input fires a
// chart rebuild on every keystroke, and rapid rebuilds from fast typing can
